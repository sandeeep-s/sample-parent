...
public class EntryWrapper implements Entry, ModelWrapper<Entry> {
    ...
    */
    ...
    @Override
    public int compareTo(com.tutorial.guestbook.model.Entry entry) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.tutorial.guestbook.model.Entry> toCacheModel() {
        return _entry.toCacheModel();
    }

    @Override
    public com.tutorial.guestbook.model.Entry toEscapedModel() {
        return new EntryWrapper(_entry.toEscapedModel());
    }

    @Override
    public com.tutorial.guestbook.model.Entry toUnescapedModel() {
