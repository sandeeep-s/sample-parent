...
public class GuestbookWrapper implements Guestbook, ModelWrapper<Guestbook> {
    ...
    */
    ...
    @Override
    public int compareTo(com.tutorial.guestbook.model.Guestbook guestbook) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<com.tutorial.guestbook.model.Guestbook> toCacheModel() {
        return _guestbook.toCacheModel();
    }

    @Override
    public com.tutorial.guestbook.model.Guestbook toEscapedModel() {
        return new GuestbookWrapper(_guestbook.toEscapedModel());
    }

    @Override
    public com.tutorial.guestbook.model.Guestbook toUnescapedModel() {
